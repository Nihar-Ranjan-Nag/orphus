...
export function BankingPartners() {
  return (
    <section className="relative overflow-hidden border-b border-t border-gold/10 bg-[#08211C] py-20">
      <div
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle 500px at 50% 50%, rgba(11,93,77,0.04) 0%, transparent 80%)",
        }}
      />
          ...
          {BANKING_PARTNERS.map((partner, idx) => (
            <motion.div
              ...
              style={{
                ...
                border: "1px solid rgba(11,93,77,0.08)",
              }}
              whileHover={{
                y: -4,
                background: "rgba(25,25,25,0.8)",
                borderColor: "rgba(11,93,77,0.28)",
                boxShadow: "0 10px 28px rgba(11,93,77,0.08)",
              }}
            >
              <BrandLogo
                src={partner.src}
