...
export function CtaBand() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-28 md:py-36" style={{ background: "linear-gradient(135deg, #D7BC78 0%, #0B5D4D 50%, #C6A45A 100%)" }}>
      <ParticleCanvas />
      ...
      <div data-inner className="relative z-10 mx-auto max-w-[800px] px-6 text-center text-[#15231F]">
        <p className="font-display text-[13px] font-bold uppercase tracking-[3px] text-[#15231F]/60">Ready to Begin?</p>
        ...
        <p className="mt-6 font-body text-[17px] text-[#15231F] max-w-xl mx-auto leading-relaxed font-bold">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <Link to="/contact">
            <button className="flex items-center gap-2 rounded-xl px-7 py-3.5 font-display font-semibold text-[15px] text-white transition-all hover:scale-105 hover:brightness-110 active:scale-95 bg-[#15231F] shadow-lg shadow-black/15">
              Book Free Consultation <ArrowRight size={14} />
            </button>
          </Link>
          <a href={PHONE_HREF} className="flex items-center gap-2 rounded-xl px-7 py-3.5 font-display font-semibold text-[15px] text-[#15231F] border border-[#15231F]/35 transition-all hover:bg-[#15231F]/5 active:scale-95">
