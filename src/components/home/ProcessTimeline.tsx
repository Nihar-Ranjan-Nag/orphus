...
export function ProcessTimeline() {
  ...
  return (
    <section className="bg-[#FFFFFF] py-28 md:py-36 relative overflow-hidden">
      <FloatingParticles count={45} color="rgba(11,93,77,0.42)" ringColor="rgba(11,93,77,0.28)" />
      ...
      <div ref={ref} className="relative mx-auto max-w-[1280px] px-6 md:px-16">
        <div className="text-center max-w-2xl mx-auto">
          <p className="font-display text-[13px] font-semibold uppercase tracking-[3px] text-gold">Our Process</p>
          ...
          <p className="mt-5 font-body text-[17px] max-w-lg mx-auto leading-relaxed font-bold" style={{ color: "rgba(29,28,28,0.85)" }}>
        ...
        <div className="relative mt-20">
          <svg viewBox="0 0 1000 20" preserveAspectRatio="none"
            ...
            <path data-line d="M0 10 L1000 10"
              stroke="#0B5D4D" strokeWidth="1.5" strokeDasharray="6 6" fill="none" />
          </svg>
            ...
            {steps.map((s) => (
              <div key={s.n} className="text-center group">
                <div data-step-circle
                  ...
                  style={{ boxShadow: "0 8px 32px rgba(11,93,77,0.22)" }}>
                  {s.icon}
                </div>
                <div data-step-text className="mt-7">
                  <div className="font-display font-bold text-[14px] uppercase tracking-[2px] text-gold mb-2">{s.n}</div>
                  <h4 className="font-display font-bold text-[17px] text-[#15231F]">{s.title}</h4>
