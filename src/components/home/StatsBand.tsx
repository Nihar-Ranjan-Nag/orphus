...
export function StatsBand() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#15231F]">
      {/* grid */}
      ...
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-40 pointer-events-none" style={{
        background: "radial-gradient(ellipse 60% 100% at 50% 50%, rgba(11,93,77,0.08) 0%, transparent 70%)",
      }} />

      <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(11,93,77,0.3), transparent)" }} />
          ...
          >
            ...
            <div className="flex flex-col items-center text-center md:flex-row md:items-start md:text-left gap-3 md:gap-4">
              ...
              <div>
                ...
                <div className="mt-2 font-display font-semibold text-[13px] uppercase tracking-[2.5px] text-gold">
                  {s.label}
                </div>
