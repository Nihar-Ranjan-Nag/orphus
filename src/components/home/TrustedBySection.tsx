  ...
  return (
    <section className="bg-charcoal py-24 relative overflow-hidden border-t border-b border-gold/10">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        background: "radial-gradient(circle 500px at 50% 50%, rgba(11,93,77,0.06) 0%, transparent 80%)"
      }} />
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-6 md:px-16">
        ...
        <div className="max-w-3xl mb-16">
          <div 
            ...
            style={{ background: "rgba(11,93,77,0.08)", border: "1px solid rgba(11,93,77,0.25)" }}
          >
            <span className="h-1.5 w-1.5 rounded-full bg-[#0B5D4D]" />
            <span className="type-eyebrow text-[#C6A45A]">Track Record & Credibility</span>
          </div>
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  borderColor: "rgba(11,93,77,0.12)",
                }}
                whileHover={{
                  y: -6,
                  borderColor: "rgba(11,93,77,0.45)",
                  boxShadow: "0 12px 30px rgba(11,93,77,0.18)",
              ...
              >
                <div>
                  ...
                  {/* Sector Tag */}
                  <span className="type-eyebrow mb-3 inline-block text-[13px] text-gold">
                    {client.sector}
                  </span>
