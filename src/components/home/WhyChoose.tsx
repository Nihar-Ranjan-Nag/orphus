...
const jurisdictions = [
  { flag: "https://www.orpheusfinancial.co/wp-content/uploads/2026/04/uae.png", name: "United Arab Emirates", tag: "Popular",      color: "#0B5D4D" },
  { flag: "https://www.orpheusfinancial.co/wp-content/uploads/2026/04/british.png", name: "British Virgin Islands", tag: "Tax-efficient", color: "#0B5D4D" },
  { flag: "https://www.orpheusfinancial.co/wp-content/uploads/2026/04/Cayman-Islands.png", name: "Cayman Islands",         tag: "Funds",        color: "#0B5D4D" },
  { flag: "🇭🇰", name: "Hong Kong",              tag: "Asia hub",     color: "#0B5D4D" },
  { flag: "https://www.orpheusfinancial.co/wp-content/uploads/2026/04/Seychelles.png", name: "Seychelles",             tag: "IBC",          color: "#0B5D4D" },
  { flag: "https://www.orpheusfinancial.co/wp-content/uploads/2026/04/marshall-island.png", name: "Marshall Islands",     tag: "Confidential", color: "#0B5D4D" },
  { flag: "🇲🇺", name: "Mauritius",              tag: "Treaties",     color: "#0B5D4D" },
];
...
export function WhyChoose() {
  ...
  return (
    <section className="bg-[#15231F] text-white py-28 md:py-36 relative overflow-hidden">
      {/* grid */}
      ...
      <div className="absolute" style={{
        ...
        background: "radial-gradient(ellipse at 60% 30%, rgba(11,93,77,0.08) 0%, transparent 65%)",
      ...
      <div className="relative mx-auto grid max-w-[1280px] gap-16 px-6 md:px-16 lg:grid-cols-2 lg:gap-20">
        ...
        {/* Left */}
        <div>
          <p className="font-display text-[13px] font-semibold uppercase tracking-[3px] text-gold">Why Choose Us</p>
          ...
          <div ref={leftRef} className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {features.map((f) => (
              <div key={f.title} data-feat
                className="site-card group rounded-2xl border border-white/[0.07] bg-white/[0.03] p-6 transition-all duration-300 hover:bg-gold/[0.07] hover:border-gold/30 cursor-default"
              >
        ...
        <div>
          <div
            ref={rightRef}
            className="site-card rounded-3xl border border-gold/15 p-8 md:p-10 lg:sticky lg:top-32"
            style={{
              background: "rgba(20,20,20,0.95)",
              boxShadow: "0 32px 80px rgba(0,0,0,0.15), inset 0 1px 0 rgba(11,93,77,0.08)",
            }}
          >
            <div className="flex items-center gap-3 mb-6">
              <Globe size={16} className="text-gold" />
              <p className="font-display text-[13px] font-semibold uppercase tracking-[3px] text-gold">Top Jurisdictions</p>
            </div>
              ...
              {jurisdictions.map((j) => (
                <li key={j.name} data-jur
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-body text-[17px] font-medium text-white/80 transition-colors group-hover:text-white">{j.name}</span>
                  </div>
                  <span className="rounded-full border border-gold/25 bg-gold/[0.08] px-3 py-1 font-display text-[11px] uppercase tracking-[1.5px] text-gold font-semibold">
                    {j.tag}
                  </span>
                </li>
              ))}
            ...
            <div className="mt-6 pt-5 border-t border-white/[0.06] flex items-center justify-between">
              <p className="font-body text-[16px] font-medium text-white/45">+12 more active jurisdictions</p>
