...
const accentColors = [
  { name: "Sovereign Gold", value: "#0B5D4D", soft: "#C6A45A" },
...
export function DesignInspector() {
  ...
  const [currentColor, setCurrentColor] = useState("#0B5D4D");
              ...
              <div className="flex flex-col gap-1.5">
                {fontFamilies.map((font) => (
                  <button
                    ...
                    style={{
                      background: currentFont === font.value ? "rgba(11,93,77,0.08)" : "rgba(255,255,255,0.03)",
