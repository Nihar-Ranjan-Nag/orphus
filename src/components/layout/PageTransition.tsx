  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 55% at 50% 50%, rgba(11,93,77,0.14) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="flex select-none flex-col items-center justify-center gap-4 sm:gap-6 px-6">
        ...
        <OrpheusWordmark className="loader-eyebrow !h-auto w-[min(72vw,520px)] object-center" />

        <div
          className="loader-line h-px rounded-full"
          style={{
            width: "clamp(140px, 28vw, 480px)",
            background: "linear-gradient(90deg, transparent, rgba(11,93,77,0.6), transparent)",
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, #08483C, #0B5D4D, #C6A45A)",
        }}
      />
    </div>
  );
