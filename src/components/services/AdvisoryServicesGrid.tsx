    ...
    <div className={className}>
      {showHeading && (
        <div className="max-w-2xl mb-10 md:mb-12">
          <p
            className={`font-display text-[13px] font-semibold uppercase tracking-[3px] ${
              isDark ? "text-gold" : ""
            }`}
            style={isDark ? undefined : { color: "#0B5D4D" }}
          >
          ...
          <p
            className={`mt-3 font-body text-[17px] leading-relaxed font-bold ${
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  background: isDark ? "rgba(11,93,77,0.12)" : "rgba(11,93,77,0.08)",
                  color: "#0B5D4D",
                }}
              >
                <Icon size={20} />
              ...
              <p
                className={`mt-2.5 flex-1 font-body text-[15px] leading-[1.75] font-semibold ${
                  isDark ? "text-white/55" : ""
                }`}
              ...
              <span
                className="mt-5 inline-flex items-center gap-1.5 font-display text-[12px] uppercase tracking-[2px] font-semibold text-gold group-hover:gap-2.5 transition-all"
              >
