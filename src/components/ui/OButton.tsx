...
const variants: Record<Variant, string> = {
  gold:
    "bg-gold text-charcoal hover:bg-gold-light shadow-[0_8px_28px_rgba(11,93,77,0.38)] font-semibold",
  white:
  ...
  "outline-sky":
    "bg-transparent text-gold border border-gold/40 hover:bg-gold hover:text-charcoal",
  sky:
    "bg-gold text-charcoal hover:bg-gold-light shadow-[0_8px_28px_rgba(11,93,77,0.35)] font-semibold",
};
