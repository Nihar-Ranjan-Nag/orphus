...
export default function WorldMap({
  ...
  return (
    <div className="relative w-full aspect-[2/1] rounded-lg bg-gradient-to-b from-[#0A2F28]/20 to-transparent font-sans overflow-hidden">
      {/* Dotted background pattern */}
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage: `radial-gradient(circle, rgba(11,93,77,0.2) 1px, transparent 1px)`,
